...
public class TouraddondemoTestContainer extends TestContainer {

    public TouraddondemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/touraddondemo/app.properties",
    ...
    public static class Common extends TouraddondemoTestContainer {

        public static final TouraddondemoTestContainer.Common INSTANCE = new TouraddondemoTestContainer.Common();
